...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($error_message)) {
		...
		$mail->addAddress('chriswilliamsehnert@localhost', 'Chris');    

		// Set email format to HTML ...this example just sends plain text...
		$mail->isHTML(false);  
		...
		if($mail->send()) {
			//redirect to page "isset" ....suggest.php?status=thanks
	...
	<div class="wrapper">
		...
		<tr>
			...
			<td><select id="category" name="category" >
				...
				<option value="Movie" <?php if (isset($category) && $category == "Movie") {
        ...
        <tr>
            ...
            <td>
                ...
                <?php
                    ...
                    $genreList = get_genre_array();

                    foreach($genreList as $category=>$options) {
